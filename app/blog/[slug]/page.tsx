...
const articles: Record<string, {
    ...
    "why-medical-students-need-simulation": {
        ...
        body: [
            ...
            { type: "paragraph", text: "Simulation offers something medicine has never previously had: a standardised, repeatable practice environment. Every student works through the same chief complaint, the same decision points, and receives structured feedback on the same clinical reasoning steps. A student at a district medical college in a Tier-3 city can work through the same STEMI presentation — one that deteriorates in real time based on how it's managed — as a student at a major urban teaching hospital. The simulation is consistent in a way that clinical exposure simply cannot be." },
